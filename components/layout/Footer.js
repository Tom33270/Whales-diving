    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        ...
        <div className={styles.social}>
          <a href="tel:+262693873336" className={`${styles.socialLink} ${styles.btn__primary}`}>
...
<a href="https://wa.me/262693873336" target="_blank" rel="noopener noreferrer" className={`${styles.socialLink} ${styles.btn__whatsapp}`}>
  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
