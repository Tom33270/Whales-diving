...
<a href="https://www.instagram.com/whale.diving/" target="_blank" rel="noopener noreferrer" className={`${styles.btn} ${styles.btn__outline}`}>
  ...
  {t('hero.cta_instagram')}
          ...
          <div className={styles.info}>
            <a 
              href="https://maps.google.com/?q=Port+de+plaisance+Saint-Gilles-les-Bains+La+Réunion"
              target="_blank"
        ...
        <div className={styles.mapCol}>
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d930.8578059941437!2d55.22309!3d-21.0554324!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sfr!2sfr!4v1787497277180!5m2!1sfr!2sfr" 
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen=""
