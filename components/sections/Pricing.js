  ...
  return (
    <section className={styles.section} id="tarifs">
      <div className={styles.container}>
        ...
        <a href="tel:+262693873336" className={`${styles.ctaBtn} ${styles.btn__primary}`}>
...
<a href="https://wa.me/262693873336" target="_blank" rel="noopener noreferrer" className={`${styles.ctaBtn} ${styles.ctaBtn__wa}`}>
  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
